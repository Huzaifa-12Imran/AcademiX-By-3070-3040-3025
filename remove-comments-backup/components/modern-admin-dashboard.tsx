        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="glass rounded-2xl p-8">
            ...
            <div className="space-y-3">
              {["Create New Course", "Manage Users", "System Settings", "Generate Reports"].map((action, i) => (
                <button
                  key={i}
                ...
                >
                  <p className="font-semibold text-foreground group-hover:text-primary transition-colors">{action}</p>
                </button>
              ))}
            </div>
          </div>
